...
#     echo "File Extension without Name: $ext"
    ...
    gatk IndexFeatureFile -I "$fullfilename" --verbosity ERROR
    gatk FastaAlternateReferenceMaker -R data/ref/NC_045512.2.fasta -O "$dir/${fname}.fasta" -V "$fullfilename" --verbosity ERROR
